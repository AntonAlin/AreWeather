...
const CACHE = 'areweather-shell-v5';
const SHELL = [
  './', './index.html', './compare.html', './methods.html', './styles.css', './manifest.webmanifest',
  './js/main.js', './js/config.js', './js/util.js', './js/api.js',
  './js/physics.js', './js/ml.js', './js/forecast.js', './js/charts.js', './js/ui.js',
  './js/methods.js', './js/compare.js', './js/i18n.js', './js/observations.js', './404.html',
